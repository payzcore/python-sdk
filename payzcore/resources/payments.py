...
class Payments:
    ...
    def create(
        ...
        *,
        ...
        Args:
            ...
            chain: Blockchain network ("TRC20", "BEP20", "ERC20", "POLYGON", or "ARBITRUM").
            external_ref: Your reference ID for this payment.
            token: Stablecoin token ("USDT" or "USDC"). Default: "USDT".
            external_order_id: Optional order ID.
        ...
        raw = self._client.post("/api/v1/payments", body)
        return {
            "success": True,
    ...
    def list(
        ...
        *,
        ...
        qs = urlencode(params)
        path = f"/api/v1/payments?{qs}" if qs else "/api/v1/payments"
    ...
    def get(self, payment_id: str) -> GetPaymentResponse:
        """Get payment details with real-time blockchain check.
        ...
        raw = self._client.get(f"/api/v1/payments/{quote(payment_id, safe='')}")
        return {
            "success": True,
    ...
    def confirm(self, payment_id: str, tx_hash: str) -> ConfirmPaymentResponse:
        ...
        raw = self._client.post(
            f"/api/v1/payments/{quote(payment_id, safe='')}/confirm",
            {"tx_hash": tx_hash},
        )
        return {
            "success": True,
